 ...
 * Build Date: 2025-08-18T21:32:58.114Z
 */
    ...
    if (document.getElementById('post-content')) {
        ...
        const applyThemeToPostContent = () => {
            ...
            textElements.forEach(element => {
                // Remove any previously injected theme classes to avoid overriding page theme
                ...
                if (isDarkTheme) {
                    if (element.tagName === 'A') { element.style.color = '#60a5fa'; }
                    ...
                    if (element.tagName === 'A') { element.style.color = '#2563eb'; }
                    if (element.tagName === 'CODE' || element.tagName === 'PRE') {
