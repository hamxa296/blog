...
async function getPostForEditing(postId) {
    console.log("getPostForEditing called with postId:", postId); 

    const user = auth.currentUser;
    console.log("Current user in getPostForEditing:", user ? user.uid : "Not logged in"); 
    ...
    try {
        ...
        if (post.authorId !== user.uid) {
            console.log("Authorization failed - user not the author"); 
            return { success: false, error: "You are not authorized to edit this post." };
        }

        console.log("Authorization successful, returning post data"); 
