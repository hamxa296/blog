            ...
            if (result.success && result.posts.length > 0) {
                result.posts.forEach(post => {
                    ...
                    postElement.innerHTML = `
                        ...
                        <a href="launching-soon.html?edit=${post.id}" class="text-sm font-semibold text-blue-600 hover:underline">Edit</a>
                    `;
                    ...
                    highlightedPhotoSection.innerHTML = `
                        <div class="relative">
                            <div class="cursor-pointer transform hover:scale-105 transition-transform duration-200" onclick="openFullscreenView(${JSON.stringify(photo)})">
                                <div class="flex items-center justify-center rounded-xl overflow-hidden bg-gray-50" style="height: 400px;">
                                    <img src="${photo.imageUrl}" alt="${photo.caption}" class="w-full h-full object-contain rounded-xl">
                                </div>
                    ...
                    highlightedPhotoSection.innerHTML = `
                        <div class="relative">
                            <div class="cursor-pointer transform hover:scale-105 transition-transform duration-200" onclick="openFullscreenView(${JSON.stringify(allPhotos[0])})">
                                                                 <div class="flex items-center justify-center rounded-xl overflow-hidden bg-gray-50" style="height: 400px;">
                                     <img src="${allPhotos[0].imageUrl}" alt="${allPhotos[0].caption}" class="w-full h-full object-contain rounded-xl">
                                 </div>
                            </div>
                            <div class="mt-4 text-center">
