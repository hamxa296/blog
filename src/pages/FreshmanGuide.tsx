...
import guide5 from '../assets/latest1.png';
import guide6 from '../assets/guide6new.png';
import guide7 from '../assets/guide7new.png';
import guide8 from '../assets/latest2.png';
...
export const FreshmanGuide: React.FC = () => {
  ...
  return (
    <main className="relative z-10 min-h-[calc(100vh-88px)] pt-10 text-foreground">
