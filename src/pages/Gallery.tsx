        ...
        <section className="relative z-20 bg-[#201e1c] backdrop-blur-xl min-h-screen px-4 sm:px-8 py-20 pb-36 border-t border-white/10">
          <div className="max-w-7xl mx-auto space-y-10">
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 border-b border-white/10 pb-8">
              <div>
                <div className="flex items-center gap-2 text-xs font-mono tracking-[0.3em] uppercase text-white/60 mb-3">
              ...
              <div>
                {user ? (
                  <button
                    ...
                    className="inline-flex items-center gap-2.5 px-6 py-3.5 rounded-full bg-white text-black font-semibold text-sm shadow-lg hover:bg-white/90 hover:scale-[1.02] active:scale-[0.98] transition duration-200 cursor-pointer"
                  >
                ...
                {filteredPhotos.map((photo, index) => {
                  ...
                  return (
                    <article
                      ...
                      className="group relative overflow-hidden rounded-2xl bg-[#201e1c] border border-white/10 hover:border-white/50 transition-all duration-300 hover:-translate-y-1.5 hover:shadow-2xl hover:shadow-white/10 cursor-pointer flex flex-col justify-between"
                    >
                      <div className="aspect-[4/5] overflow-hidden bg-[#201e1c] relative">
                        ...
                        <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
                          <div className="w-12 h-12 rounded-full bg-white/90 text-black flex items-center justify-center shadow-lg transform translate-y-4 group-hover:translate-y-0 transition-transform duration-300">
            ...
            >
              ...
              <div>
                ...
                {!uploadPreview ? (
                  <label
                    ...
                    className="border-2 border-dashed border-white/20 hover:border-white/40 rounded-2xl p-8 flex flex-col items-center justify-center text-center cursor-pointer bg-black/40 hover:bg-white/5 transition duration-200 group"
                  >
                    <div className="w-12 h-12 rounded-full bg-white/5 group-hover:bg-white/10 text-neutral-400 group-hover:text-white flex items-center justify-center mb-3 transition">
                  ...
                  <div className="relative rounded-2xl overflow-hidden bg-black aspect-video border border-white/10 flex items-center justify-center group">
                    ...
                    <div className="absolute bottom-3 left-3 bg-black/70 backdrop-blur-md px-3 py-1 rounded-full text-[11px] text-white/70 font-mono border border-white/10">
              ...
              <div>
                ...
                <input
                  ...
                  maxLength={100}
                  className="w-full px-4 py-3 rounded-xl bg-black/60 border border-white/15 text-white placeholder-neutral-600 text-sm focus:outline-none focus:border-white/40 transition"
                />
              </div>
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-4 py-3 rounded-xl bg-black/60 border border-white/15 text-white text-sm focus:outline-none focus:border-white/40 transition"
                >
                  {CATEGORIES.filter(
                    (c) => c !== 'All'
                  ).map((cat) => (
              ...
              <div className="pt-2">
                <button
                  ...
                  className="w-full py-4 rounded-2xl bg-white hover:bg-white/90 disabled:opacity-50 disabled:cursor-not-allowed text-black font-bold text-sm shadow-xl transition flex items-center justify-center gap-2 cursor-pointer"
                >
                  {uploading ? (
                    <>
      ...
      {currentLightboxPhoto && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/95 backdrop-blur-2xl animate-fade-in p-4 sm:p-10">
          ...
          {filteredPhotos.length > 1 && (
            <button
              onClick={handlePrev}
              className="absolute left-4 sm:left-8 z-20 w-12 h-12 rounded-full bg-black/60 hover:bg-white/20 text-white border border-white/15 flex items-center justify-center transition-all duration-200 cursor-pointer"
          ...
          {filteredPhotos.length > 1 && (
            <button
              onClick={handleNext}
              className="absolute right-4 sm:right-8 z-20 w-12 h-12 rounded-full bg-black/60 hover:bg-white/20 text-white border border-white/15 flex items-center justify-center transition-all duration-200 cursor-pointer"
