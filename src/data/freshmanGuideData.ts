...
export type SocietyItem = { name: string; description: string };
...
export const dormMediaConfig: Record<'boysHostel' | 'girlsHostel', { media: DormMediaItem[] }> = {
  boysHostel: {
    media: [
      {
...
export const normalizeItem = (s: string) => s.toLowerCase().trim();
...
export const PACKING_GUEST_KEY = 'packing_progress_guest';
export const CUSTOM_ITEMS_GUEST_KEY = 'user_custom_items_guest';
