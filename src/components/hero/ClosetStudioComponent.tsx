...
const MOCK_PRODUCTS = [
  {
    ...
    description:
      'A timeless outer layer designed with absolute minimalism, premium waterproof cotton, and a classic silhouette.',
    collection: {
  ...
  },
  {
    ...
    description:
      'An elegant midi dress crafted from 100% organic mulberry silk, featuring a delicate drape and a refined scoop neckline.',
    collection: {
  ...
  },
  {
    ...
    description:
      'An incredibly soft, oversized sweater knit from pure Mongolian cashmere, designed for effortless layering.',
    collection: {
      title: 'Essentials',
    },
    price: '$199.00',
    ...
    >
      ...
      <div className="relative aspect-[3/4] w-full overflow-hidden bg-muted">
        ...
        {fullImageUrl && (
          ...
          >
            <FillImage src={fullImageUrl} alt={product.title} className="object-cover" />
          </div>
        )}
...
function ProductHero({ product, reversed = false }: { product: Product; reversed?: boolean }) {
        ...
        <div className="w-full h-auto md:h-full grid grid-cols-1 md:grid-cols-2">
          ...
          >
            <div className="relative w-full aspect-[4/5] md:aspect-auto md:h-full overflow-hidden rounded-2xl md:rounded-none">
              ...
              >
                {fullImageUrl && (
                  <FillImage src={fullImageUrl} alt={product.title} className="object-contain" priority />
                )}
              </div>
            </div>
          </div>
            ...
            <div className="max-w-sm md:max-w-md w-full flex flex-col gap-6 md:gap-10">
              ...
              >
                ...
                <div className="flex items-center gap-3">
                  <span className="text-base sm:text-xl font-medium text-foreground">{product.price}</span>
                </div>
              </div>
              ...
              <div
                ...
                data-progress="0.8"
              >
                <Link to={`/products/${product.handle}`} className="w-full block">
                  <button
                    type="button"
...
export function ClosetStudioComponent() {
    ...
    >
      ...
      <section className="relative h-[100dvh] w-full flex flex-col justify-center items-center overflow-hidden bg-transparent">
        ...
        >
          ...
          <span className="text-[9px] font-bold text-foreground/40 tracking-normal">SCROLL DOWN</span>
        </div>
      </section>
...
export default ClosetStudioComponent;
