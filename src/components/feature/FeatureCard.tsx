...
export const FeatureCard: React.FC<FeatureCardProps> = ({
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-gradient-to-t from-[#08080a] via-black/60 to-black/30 z-[2] pointer-events-none" />
      ...
      <div className="relative z-10 flex items-end justify-center px-4 sm:px-5 pb-16 pt-8 border-r border-white/10 bg-black/20 backdrop-blur-xs select-none h-full">
        <span className="writing-mode-vertical text-5xl sm:text-6xl lg:text-7xl font-black tracking-[0.2em] uppercase text-white/20 drop-shadow-md">
          {verticalTitle}
        </span>
      </div>
      ...
      <div className="relative z-10 flex-1 flex flex-col justify-between p-6 sm:p-8 lg:p-10 pb-16">
        ...
        <div className="flex flex-col gap-4 mt-auto mb-4 pt-28 sm:pt-32">
          <div className="flex flex-col">
            <span className="text-5xl sm:text-6xl lg:text-7xl font-black tracking-tight text-white uppercase leading-[0.85] drop-shadow-xl">
              {topHeading}
            </span>
            <span
              className="text-5xl sm:text-6xl lg:text-7xl font-black tracking-tight uppercase leading-[0.85] drop-shadow-2xl"
