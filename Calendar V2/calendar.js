        ...
        try {
            ...
            return {
                ...
                events: {
                    '2025-08-10': [{
                        id: 'dummy-id-1',
                        name: 'Tech Society Workshop',
                        date: '2025-08-10',
                        time: '14:00',
                        type: 'Tech',
                        location: 'Room 302',
                        description: 'A workshop on web development basics.'
                    }, {
                        id: 'dummy-id-1-2',
                        name: 'Game Night',
                        date: '2025-08-10',
                    ...
                    '2025-08-15': [{
                        ...
                        description: 'A showcase of cultural performances.'
                    }],
                    '2025-08-20': [{
                        id: 'dummy-id-4',
                        ...
                        description: 'A seminar on the future of AI in academia.'
                    }]
                }
            };
        } catch (error) {
    ...
    function createEventDetailsCard(event) {
        ...
        eventCard.innerHTML = `
            ...
            <div class="popup-buttons">
                ...
                <button class="delete-event-btn" data-event-id="${event.id}">Delete Event</button>
            </div>
        `;
        ...
        eventCard.querySelector('.delete-event-btn').addEventListener('click', () => {
