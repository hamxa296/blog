...
- [x] Migrate Photo Gallery:
  - [x] Responsive grid layout with filters & resolution capping
  - [x] Lightbox slide view overlay
  - [x] Cloudinary client-side upload handler integration
